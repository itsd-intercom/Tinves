...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h3 class="mb-sm-2">Data SPK & DO </h3><br></br>
            <hr>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a type="button" class="btn btn-dark btn-rounded waves-effect waves-light btn-add"
                        data-bs-toggle="modal" data-bs-target="#modalAstragraphia" style="float:right">
                        + Add Data
                    </a><br>
                                ...
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ route('admin.store') }}"
                                            enctype="multipart/from-data" id="myForm">
                                            @csrf
                    ...
                    <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formEdit" method="POST" action="{{ route('perusahaan.update', $item->id) }}" enctype="multipart/from-data" id="myForm">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div id="perusahaanFields" >
                                            ...
                                            <div class="row">
                                                <div class="col-8 mb-3">
                                                    <label for="text" class="col-sm-10 col-form-label">Keterangan</label>
                                                    <div class="form-group col-11">
                                                        <input name="keterangan" class="form-control" type="text" placeholder="" id="keterangan">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
$(function() {
    $('#admin-datatable').DataTable({
        ...
        createdRow: function(row, data, dataIndex) {
            ...
            var actionBtns = '<a href="/index-edit-' + data.id +
                '" class="btn btn-success btn-sm mr-2 " id="btn-edit" style="margin-right: 4px;"> <i class="fas fa-edit"></i></a>' +
                '<a href="/InventarisDelete-' + data.id +
                '" class="btn btn-danger btn-sm" style="margin-right: 4px;"> <i class="fas fa-trash-alt"></i></a>' +
                '<a href="/InventarisDetails-' + data.id +
                '" class="btn btn-info btn-sm" style="margin-right: 4px;"> <i class="fa thin fa-info"></i></a>';
            //  '<a href="/index-edit-' + data.id + '" class="btn btn-info sm btn-sm  mr-2 btn-edit"  style="margin-right: 4px;"> <i class="fas fa-edit"></i></a>';
    ...
    $('.btn-edit').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#formEdit').attr('action', "{{ route('perusahaan.update', ':id') }}".replace(':id', id));
